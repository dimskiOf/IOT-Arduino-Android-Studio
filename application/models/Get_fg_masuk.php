...
class Get_fg_masuk extends CI_Model {

    var $table = 'warehouse_fg_masuk a'; //nama tabel dari database
    var $column_order = array(null,'a.load_nmbr','a.id_identific','a.id_barang_fg','b.unit1','b.quantity', 'a.inputminusplus','b.quantity','a.tgl_create_fg','a.id_fg_masuk'); //field yang ada di table user
