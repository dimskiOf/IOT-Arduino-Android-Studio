<?php
class Get_fg99_keluarmasuk extends CI_Model {
   ...
   function get_fg99_keluar($query,$cari,$where,$iswhere)
        {
        ...
        function get_fg99_masuk($query,$cari,$where,$iswhere)
        {
            $gd99 = $this->load->database('gd99', TRUE);
            // Ambil data yang di ketik user pada textbox pencarian
            $search = htmlspecialchars($_POST['search']['value']);
       ...
       {
        $gd99 = $this->load->database('gd99', TRUE);
        $gd99->where('ID_FG_KELUAR', $this->input->post('id'));
        return  $gd99->delete('WAREHOUSE_FG_KELUAR');
       }
       ...
       {
        $gd99 = $this->load->database('gd99', TRUE);
        $gd99->where('ID_FG_MASUK', $this->input->post('id'));
        return  $gd99->delete('WAREHOUSE_FG_MASUK');
       }
