...
function onMessageArrived(message) {
 ...
 // table.ajax.reload();
  }else if(message.payloadString == 'data fgmpi update'){
   tabled.ajax.reload(); 
    ...
    $(document).ready( function () {
       ...
       "processing": true,
        ...
        "order": [[ 0, 'desc' ]],
        "ajax": {
            "url": "<?php echo base_url('mpi/loadfg')?>",
            "type": "POST"
        },
       dom : 'Bfrtip',
        "buttons": [{
...
$(document).ready( function () {
       ...
       "processing": true,
        ...
        "order": [[ 0, 'asc' ]],
        "ajax": {
            "url": "<?php echo base_url('mpi/getadddatafg')?>",
            "type": "POST"
        },
        "columnDefs": [
            {
...
function hapusfgkeluar(idi)
    {
        ...
        $.ajax({
                  type: "POST",
                  url: "<?php echo base_url(); ?>mpi/hapusfgkeluar",
                  data: {id : idi},
                  dataType:"json",
 ...
 function hapusfgmasuk(idi)
    {
        ...
        $.ajax({
                  type: "POST",
                  url: "<?php echo base_url(); ?>mpi/hapusfgmasuk",
                  data: {id : idi},
                  dataType:"json",
                  success: function (data) {
                    $.each(data,function(pesan){
...
function hapusadditem(idi)
    {
        ...
        $.ajax({
                  type: "POST",
                  url: "<?php echo base_url(); ?>mpi/hapusadditemfg",
                  data: {id : idi},
                  dataType:"json",
                  success: function (data) {
                    $.each(data,function(pesan){
...
$(document).ready(function(){
 ...
 $("#selUser").select2({
  ajax: { 
   url: "<?php echo base_url('mpi/select2getfg') ?>",
   type: "post",
   dataType: 'json',
   delay: 250,
   ...
   cache: true
    ...
    $(document).ready(function () {
        ...
        $("#printthisbarcode").click(function (event){
            window.open('<?php echo base_url('mpi/printbarcodefg'); ?>','_blank');
         })
          ...
          $("#senddata").click(function (event) {
              ...
              $.ajax({
                  ...
                  url: "<?php echo base_url('mpi/addbarcodefg'); ?>",
                  data: data,
                  processData: false,
                  contentType: false,
                  cache: false,
