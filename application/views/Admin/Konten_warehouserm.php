  ...
  <div class="content-wrapper">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Barang RM</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <br>
    ...
    <!-- /.content -->
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Warehouse RM Keluar</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control float-right" id="rmkeluarfilter">
                  </div>
                  <!-- /.input group -->
                </div>
                <table id="rmkeluar" class="table table-bordered table-striped">
                  <thead>
                  <tr>
                    <th>No</th>
                    <th>Load Number</th>
