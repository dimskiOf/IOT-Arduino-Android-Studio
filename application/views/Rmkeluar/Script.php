 ...
 // table.ajax.reload();
  ...
  $('#rmkeluarfilter').daterangepicker({
    ...
    $(document).ready( function () {
       window.tabless = $('#rmkeluar').DataTable({ 
        "processing": true,
        "serverSide": true,
        "order": [],
        "ajax": {
            "url": "<?php echo base_url('rmkeluar/loadrmkeluar')?>",
            "type": "POST",
...
$(document).ready( function () {
       ...
       "processing": true,
        ...
        "order": [],
        "ajax": {
            "url": "<?php echo base_url('rmkeluar/getadddatarm')?>",
            "type": "POST"
        },
        "columnDefs": [
            {
...
function hapusrmkeluar(idi)
    {
        ...
        $.ajax({
                  type: "POST",
                  url: "<?php echo base_url(); ?>rmkeluar/hapusrmkeluar",
                  data: {id : idi},
                  dataType:"json",
    ...
    function hapusadditem(idi)
    {
        ...
        $.ajax({
                  type: "POST",
                  url: "<?php echo base_url(); ?>rmkeluar/hapusadditemrm",
                  data: {id : idi},
                  dataType:"json",
                  success: function (data) {
                    $.each(data,function(pesan){
...
$(document).ready(function(){
 ...
 $("#selUser").select2({
  ajax: { 
   url: "<?php echo base_url('rmkeluar/select2getrm') ?>",
   type: "post",
   dataType: 'json',
   delay: 250,
   ...
   cache: true
    ...
    $(document).ready(function () {
        ...
        $("#printthisbarcode").click(function (event){
            window.open('<?php echo base_url('rmkeluar/printbarcoderm'); ?>','_blank');
         })
          ...
          $("#senddata").click(function (event) {
              ...
              $.ajax({
                  ...
                  url: "<?php echo base_url('rmkeluar/addbarcoderm'); ?>",
                  data: data,
                  processData: false,
                  contentType: false,
                  cache: false,
