...
function onMessageArrived(message) {
 ...
 // table.ajax.reload();
  }else if(message.payloadString == 'data fgmpi masuk'){
    tabless.ajax.reload();
  }
}
  ...
  $('#fgmasukfilter').daterangepicker({
    ...
    $(document).ready( function () {
       window.tabless = $('#fgmasuk').DataTable({ 
        ...
        "order": [],
        "ajax": {
            "url": "<?php echo base_url('fgmasuk/loadfgmasuk')?>",
            "type": "POST",
        ...
        "columnDefs": [
            ...
            { 
                ...
                "mRender" : function(data, type, full){
                    return '<tr><td><button class="btn btn-sm btn-danger text-white" onclick=hapusfgmasuk("'+full[9]+'"); title="Hapus Item"><i class="fa fa-trash"></i></button></td></tr>';
                }
            }],
       dom : 'Bfrtip',
        "buttons": [{
...
$(document).ready( function () {
       ...
       "processing": true,
        ...
        "order": [],
        "ajax": {
            "url": "<?php echo base_url('fgmasuk/getadddatafg')?>",
            "type": "POST"
        },
        "columnDefs": [
            {
...
function hapusfgmasuk(idi)
    {
        ...
        $.ajax({
                  type: "POST",
                  url: "<?php echo base_url(); ?>fgmasuk/hapusfgmasuk",
                  data: {id : idi},
                  dataType:"json",
    ...
    function hapusadditem(idi)
    {
        ...
        $.ajax({
                  type: "POST",
                  url: "<?php echo base_url(); ?>fgmasuk/hapusadditemfg",
                  data: {id : idi},
                  dataType:"json",
                  success: function (data) {
                    $.each(data,function(pesan){
...
$(document).ready(function(){
 ...
 $("#selUser").select2({
  ajax: { 
   url: "<?php echo base_url('fgmasuk/select2getfg') ?>",
   type: "post",
   dataType: 'json',
   delay: 250,
   ...
   cache: true
    ...
    $(document).ready(function () {
        ...
        $("#printthisbarcode").click(function (event){
            window.open('<?php echo base_url('fgmasuk/printbarcodefg'); ?>','_blank');
         })
          ...
          $("#senddata").click(function (event) {
              ...
              $.ajax({
                  ...
                  url: "<?php echo base_url('fgmasuk/addbarcodefg'); ?>",
                  data: data,
                  processData: false,
                  contentType: false,
                  cache: false,
